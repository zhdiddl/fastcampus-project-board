...
public class ArticleComment extends AuditingFields {
    ...
    @Setter @ManyToOne(optional = false) private Article article; // 게시글 (ID) - ArticleComment 는 반드시 Article 와 연결
    @Setter @ManyToOne(optional = false) private UserAccount userAccount; // 유저 정보 (ID) - ArticleComment 는 반드시 UserAccount 와 연결
